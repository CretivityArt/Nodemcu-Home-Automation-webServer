...
const char* ssid = "redme9";
const char* password = "Angshu201";
...
pinMode(relay4LED,OUTPUT);
// Set outputs to LOW
digitalWrite(redLED, LOW);
digitalWrite(greenLED, LOW);
digitalWrite(yellowLED, LOW);
digitalWrite(relay4LED, LOW);
...
client.println("<title>MY HOME Controll</title>");
client.println("<link rel=\"icon\" href=\"data:,\">");
//client.println("body {background-color: #92a8d1;}");
...
client.println("text-decoration: none; font-size: 30px; margin: 2px; cursor: pointer;}");
client.println(".buttonBlue { background-color: #1D65F4; border: none; color: white; padding: 16px 40px; border-radius: 60%;");
client.println("text-decoration: none; font-size: 30px; margin: 2px; cursor: pointer;}");

client.println(".buttonRelay { background-color: #FFFF00; border: none; color: white; padding: 16px 40px; border-radius: 60%;");
client.println("text-decoration: none; font-size: 30px; margin: 2px; cursor: pointer;}");
...
// Web Page Heading
client.println("<body bgcolor=""Magenta""><h1>My Relay Control Server</h1>");

// Display current state, and ON/OFF buttons for GPIO 2 Red LED 
client.println("<p>Light is turned" + outputRedState + "</p>");
...
client.println("<p>Fan is turned" + relay4 + "</p>");
// If the outputRedState is off, it displays the OFF button 
if (relay4=="off") {
client.println("<p><a href=\"/14/on\"><button class=\"button buttonOff\">OFF</button></a></p>");
} else {
client.println("<p><a href=\"/14/off\"><button class=\"button buttonRelay\">ON</button></a></p>");
}
// If the outputRedState is off, it displays the OFF button 
...
client.println("<p>Light2 is " + outputGreenState + "</p>");
...
client.println("<p>Fan2 is " + outputYellowState + "</p>");
